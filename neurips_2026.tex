...
We substantiate these contributions empirically. Across five environments, the gating policy which adaptively selects among a set of planning budgets outperforms baselines constrained to use a single fixed planning budget at every step. We qualitatively find that the agent with the gating policy learns to plan for longer when it is able to do so and acts promptly when it is under pressure and demonstrate examples across our environments of when this happens.
