...
modify the Jumanji environment so that gravity advances the piece in real time.
...
is that a deeper plan arrives later, after the world has already changed; environment
details for the real-time Tetris implementation are given in the appendix.
