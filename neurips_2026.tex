...
game: control falls back to $\pi_{\mathrm{reflex}}$, making the task one of resource
allocation rather than mere timeout avoidance. Appendix~\ref{app:hex_timeout_control}
reports the easier strict-timeout Speed Hex control.
