...
allocation rather than mere timeout avoidance. Because the strict-timeout variant
proved too easy, we use this harder $\pi_{\mathrm{reflex}}$-fallback setting as the
main benchmark (Appendix~\ref{app:hex_timeout_control}).
