...
\begin{enumerate}
  \item \textbf{Variable-delay real-time RL.}
    ...
    each decision point. We also introduce a set of real-time RL environments where the environment progresses and updates while the agent is planning.
    \item \textbf{Planning quality vs.\ inference time.}
  ...
  \item \textbf{Adaptive gating on a frozen planner.}
    ...
    AlphaZero planner, that selects a state-dependent planning budget
    at each decision.
\end{enumerate}
