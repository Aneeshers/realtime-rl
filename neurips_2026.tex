...
less average compute. The strategy it learns is interpretable as computation is
...
unremarked. Yet it is entirely absent from the standard reinforcement learning (RL) framework.
