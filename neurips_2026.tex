...
\begin{figure}[t]
  ...
  \caption{Main results (mean $\pm$\,SE, 100 episodes).
    ...
    For both Speed Hex and Speed Go, we report expected score averaged over the
    same five sampled clock budgets, $T \in \{300, 1200, 2300, 3500, 4800\}$.}
...
\begin{figure}[t]
  ...
  \caption{Clock pressure changes how compute is allocated. In both Speed Hex and
    ...
    available ($T{=}4100$). Additional per-environment strategy profiles appear in
    Appendix Figure~\ref{fig:strategy_appendix}.}
  \label{fig:strategy}
\end{figure}
