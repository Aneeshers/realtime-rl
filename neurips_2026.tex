...
We study planning agents in real-time environments that must confront that
deliberation takes time in which the environment continues to evolve.
Building on prior real-time formalizations, we introduce
\emph{variable-delay real-time RL}, where the agent chooses how long
to deliberate at each decision point.
%Y Why is this hard
