...
principle: the options are spaced roughly linearly in log-simulation space,
providing distinct low-, medium-, and high-compute operating points rather than
redundant nearby budgets.
The right-hand panel of Figure~\ref{fig:clock_budget_calibration} is included as
an illustrative calibration sketch for this spacing; the full dense Hex
inference-budget tournament is being generated separately.
Thus, in both clocked domains, the selected options are intended to provide the
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{figures/clock_budget_calibration_go_hex_mock.pdf}
  \caption{
    ...
    The Speed Go panel uses the measured inference-tournament data, while the
    Speed Hex panel is an illustrative mock-up showing the intended logarithmic
    spacing of the selected options.}
