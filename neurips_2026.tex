...
nearest-ghost distance in Pac-Man: the policy most often selects $K{=}1$ when the
nearest ghost is relatively close, shifts toward $K{=}2$ at intermediate distances,
and reaches for $K{=}4$ when the nearest ghost is farthest away. When ghosts are frightened the threat evaporates, and
