...
\begin{figure}[h]
  ...
  \caption{Planning quality and real-time inference latency co-scale with simulation
    ...
    \emph{Dashed lines}: per-step inference latency on H100 (measured, filled markers),
    A100, and V100 (synthetic estimates; diverge at high simulation counts).
    Shaded band shows $\pm$SE for H100.
    Filled markers indicate measured data points; open markers indicate linear extrapolation.
    Snake results are placeholder (training in progress).}
  \label{fig:scaling}
\end{figure}
