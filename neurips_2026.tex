...
\subsection{Committed-action environments: Pac-Man, Tetris, Snake}
\label{sec:committed}
...
variant of Tetris (Appendix~\ref{app:envs_tetris}).
...
We now describe the information used to choose the planning budget $K$
at each meta-step.
...
\paragraph{Baselines.}
For Pacman, Tetris, and Snake we compare against: \emph{always-$K$} policies for
