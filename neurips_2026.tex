...
\title{Learned Planning Budgets for Real-Time RL}
...
Across real-time Pac-Man, real-time Tetris, Snake, Speed Hex,
and Speed Go, the gating policy outperforms fixed-budget and
heuristic baselines, and transfers to a true two-GPU deployment with
...
\emph{variable-delay real-time RL}, a regime where the agent chooses,
at each decision point, how long to deliberate before its action takes
effect.
