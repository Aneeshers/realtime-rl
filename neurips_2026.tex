...
In these clocked settings, $K{=}1,\dots,4$ denotes
the four available simulation-budget options rather than a number of committed-actions: for Speed Hex these correspond to 2/8/32/128 simulations, while for Speed Go they correspond to 16/32/64/96 simulations. Against the fixed-budget baselines and the greedy, midpeak, and random heuristics, the gating policy remains above parity on average and outperforms these opponents overall.
