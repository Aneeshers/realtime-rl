...
In committed-action environments these are fast, approximate decisions drawn from
the planner's policy that keep the agent moving without full deliberation; in
