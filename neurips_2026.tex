...
Moreover, we validate the full pipeline in a true two-GPU real-time setup. We demonstrate these results across real-time versions of Pac-Man, Tetris, Snake, and two clocked two-player PGX games: Speed Hex and Speed Go.
