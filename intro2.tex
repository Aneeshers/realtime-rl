...
point, how many timesteps to spend deliberating before its considered
...
The problem of choosing how many timesteps to plan is fundamentally a problem of \emph{meta-reasoning}:
...
We instead let the agent \emph{choose} how many timesteps to plan at each decision
