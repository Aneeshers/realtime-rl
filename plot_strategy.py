...
LINE_WIDTH       = 1.8
MARKER_EVERY     = 3          # place a marker every N points
MARKER_SIZE      = 4

# Line colors for K=1, K=2, K=3, K=4 (and sim-count equivalents)
LINE_COLORS = ["#2171b5", "#e6550d", "#31a354", "#756bb1"]
LINE_STYLES = ["-", "-", "-", "--"]     # K=4/128sims dashed to stand out
K3_ALPHA    = 0.30                      # K=3 always 0 — de-emphasize
